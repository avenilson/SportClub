...
namespace SportClub.Pages.Coach
{
    ...
    {
        protected internal CoachesPage(ICoachesRepository r) : base(r) => PageTitle = "Coaches";

        public override string ItemId => Item?.Id ?? string.Empty;

        public override string GetPageUrl() => "/Coach/Coaches";

        public override Domain.Coach.Coach ToObject(CoachView view) => CoachViewFactory.Create(view);

        public override CoachView ToView(Domain.Coach.Coach obj) => CoachViewFactory.Create(obj);
    }
}