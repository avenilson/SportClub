...
namespace SportClub.Pages.Participant
{
    ...
    {
        protected internal ParticipantsPage(IParticipantsRepository r) : base(r) => PageTitle = "Participants";

        public override string ItemId => Item?.Id ?? string.Empty;

        public override string GetPageUrl() => "/Participant/Participants";

        public override Domain.Participant.Participant ToObject(ParticipantView view) => ParticipantViewFactory.Create(view);

        public override ParticipantView ToView(Domain.Participant.Participant obj) => ParticipantViewFactory.Create(obj);
    }
}