...
namespace SportClub.Tests.Aids.Regions {
    ...
    [TestClass] public class SystemCultureInfoTests : BaseTests {
        ...
        [TestMethod] public void GetSpecificTest() {
            var expected =
        ...
        [TestMethod] public void ToRegionInfoNullTest() {
            var r = SystemCultureInfo.ToRegionInfo(null);
            Assert.IsNull(r);
        }

        [TestMethod] public void WrongTypeTest() {
