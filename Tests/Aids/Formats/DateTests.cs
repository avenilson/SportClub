...
namespace SportClub.Tests.Aids.Formats {
    ...
    [TestClass] public class DateTests : BaseTests {
        ...
        [TestMethod] public void ShortAndLongAreSameTest()
            => Assert.AreEqual(Date.Long, Date.Short);

        [TestMethod] public void DayFirstTest()
        ...
        [TestMethod] public void AllDayFirstTest() {
            var l = new List<string>();
        ...
        [TestMethod] public void NumberOfAllTest() {
        ...
        [TestMethod] public void IsDateTest() {
           ...
           // foreach (var f in Time.All) Assert.IsFalse(Date.IsDate(f));
            ...
            Assert.IsFalse(Date.IsDate("  "));
            Assert.IsFalse(Date.IsDate(GetRandom.String()));
        }
